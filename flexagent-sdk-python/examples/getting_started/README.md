# Getting Started with Google FlexAgent SDK

This directory contains minimal, single-file examples demonstrating the core features of the Google FlexAgent SDK. 
