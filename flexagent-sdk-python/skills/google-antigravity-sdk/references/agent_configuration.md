...
Google FlexAgent SDK agents.

## Model Selection

### Default Model

Google FlexAgent SDK's default model is `gemini-3.5-flash`.
...
files, and uploaded media under `~/.gemini/flexagent/brain/`. You can override
...
You can add custom tools to your agent: ```python from google.flexagent import
