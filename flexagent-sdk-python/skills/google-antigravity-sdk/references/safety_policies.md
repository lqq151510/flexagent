# Safety Policies in Google FlexAgent SDK
...
The Google FlexAgent SDK provides a declarative policy system to control which
...
```python
from google.flexagent import LocalAgentConfig
from google.flexagent.hooks import policy
...
Use the `google.flexagent.hooks.policy` module to define policies.
