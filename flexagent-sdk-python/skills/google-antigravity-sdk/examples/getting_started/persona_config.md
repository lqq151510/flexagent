...
agent using the Google FlexAgent SDK. You can either append to the default
...
from google.flexagent.types import TemplatedSystemInstructions
...
```python
from google.flexagent import Agent, LocalAgentConfig
from google.flexagent.types import CustomSystemInstructions
