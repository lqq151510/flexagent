...
# Kokoro presubmit script for flexagent-sdk-py.
...
python3 -c "from google.flexagent.agent import Agent; print('Import OK: Agent')"
python3 -c "from google.flexagent.connections.local_connection import LocalConnection; print('Import OK: LocalConnection')"
